...
#if defined(CONFIG_PCI_MSI_ARCH_FALLBACKS) || defined(CONFIG_PCI_XEN) || defined(CONFIG_MUEN_PCI)
/**
...
#endif /* CONFIG_PCI_MSI_ARCH_FALLBACK || CONFIG_PCI_XEN || CONFIG_MUEN_PCI */
#else /* CONFIG_SYSFS */
